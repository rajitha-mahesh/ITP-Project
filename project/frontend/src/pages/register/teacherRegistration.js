...
export default function TeacherRegistration  ()  {
    ...
    function submitTeacher(e) {
        ...
        axios.post("http://localhost:8070/teacher_register/addTeacher", teacher_register)
            .then((res) => {
    ...
    return (
        ...
        <Box py={4}  sx={{bgcolor: "#F8F9FD", minHeight:"100vh"}}>
            <BoxWithShadow  sx={{bgcolor: "#FBFBFB",}}>
                <form onSubmit={submitTeacher} encType={"multipart/form-data"}>
                    <Grid container direction={"column"}>

                        <Grid item align={"center"} paddingY={5}>
                            <Typography variant={"h3"}>Teacher Registration Form</Typography>
                        </Grid>
                        <Grid item pl={3}>
                        ...
                        >
                            ...
                            <Grid item direction={"column"} lg={10 / 3} sm={12} xs={12}
                                // sx={{bgcolor: "#139b8b"}}
                                px={1}>
                        ...
                        >
                            ...
                            >
                                <Typography variant={"h6"}
                                            // sx={{bgcolor: "#0034ff"}}
                                >* Subjects Prefer To Teach </Typography>
                            </Grid>
                        ...
                        >
                            ...
                            <Typography variant={"h6"}
                                        // sx={{bgcolor: "#0034ff"}}
                            >Education Qualification</Typography>
                        ...
                        >
                            ...
                            <TextField rows={8} rowsMax={10} multiline id="outlined-basic" label="Education Qualification"
                                    variant="outlined"
                                    fullWidth
                                    value={educationQualification}
                                    onInput={e => setEducationQualification(e.target.value)}/>
                        </Grid>
                        ...
                        >
                            ...
                            <TextField rows={4} rowsMax={10} multiline id="outlined-basic" label="Experience"
                                    variant="outlined"
                                    fullWidth
                                    value={experience}
                    ...
                    <Grid container direction={"row"} pb={2} px={5}
                        ...
                        <Grid item direction={"column"} md={2} sm={6} xs={12}
                            ...
                            justifyContent="center" px={1} py={1}
                        >
                            <Button type='submit' variant={"contained"} sx={{padding: "15px", backgroundColor:"#00B74A"}}>Submit</Button>
                        </Grid>
